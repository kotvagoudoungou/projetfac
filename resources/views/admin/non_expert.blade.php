      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          ...
          <h6 class="collapse-header">Categorys:</h6>
            <a class="collapse-item" href="utilities-color.html">COVID-19</a>
            <a class="collapse-item" href="utilities-border.html">EDUCATION</a>
            <a class="collapse-item" href="utilities-animation.html">POLITIQUE</a>
            <a class="collapse-item" href="utilities-other.html">ECONOMIE</a>
            <a class="collapse-item" href="utilities-other.html">SPORT</a>>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Non-expert </h1>
          <p class="mb-4">Les utilisateus ordinaires.</p>
