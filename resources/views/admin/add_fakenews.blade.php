      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          ...
          <h6 class="collapse-header">Custom Components:</h6>
            <a class="collapse-item" href="collector">collectors</a>
            <a class="collapse-item" href="non_expert">Non-expert</a>
          </div>
        </div>
      </li>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
                    ...
                    <h2 class="title">Fake News Registration</h2>
                    <form action="{{ url('fakesnews') }}" method="POST">
                      @csrf
                    <div class="form-group">
                    <label for="">Titre</label><br>
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      <input name="nom" type="text" class="form-control form-control-user"  placeholder="titre du fake news">
                    </div><br>

                      <div class="field">
                                      <div class="col-2">
                                      <label class="label">Description : </label>
                <textarea name="description" id="" cols="55" rows="10"></textarea>
              </div>
                                  </div>
                                  <div class="col-2">
                                  <div class="field">
