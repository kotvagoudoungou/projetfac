      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          ...
          <h6 class="collapse-header">Categorys:</h6>
            <a class="collapse-item" href="corona">COVID-19</a>
            <a class="collapse-item" href="education">EDUCATION</a>
            <a class="collapse-item" href="politique">POLITIQUE</a>
            <a class="collapse-item" href="economie">ECONOMIE</a>
            <a class="collapse-item" href="sport">SPORT</a>>
          </div>
        </div>
      </li>
